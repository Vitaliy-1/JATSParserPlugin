...
$('#pkp_content_main').attr("class", "pkp_structure_main col-lg-7 col-md-7 col-sm-12 col-xs-12");
...
$(function () {
    ...
    $('#myAffix').affix({
      offset: {
        ...
        bottom: $('div.pkp_content_footer').outerHeight(true)
        /* bottom: $(document).height() - $('div.section:last').offset().top - $('div.section:last').outerHeight(true) - $('#myAffix').outerHeight() - 100 */
      }
    });
});
/*
